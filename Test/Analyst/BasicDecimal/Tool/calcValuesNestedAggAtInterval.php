 ...
 * @version     $Id: calcValuesNestedAggAtInterval.php 298 2009-02-13 05:19:37Z david $
*/

$expValues = array();

$aggFunctions = Hashmark_TestCase_Analyst_BasicDecimal::getAggFunctions();
foreach ($expProviders['provideValuesAggAtInterval'] as $sampleProviderName => $providerAggs) {
